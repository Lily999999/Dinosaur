...
public class VendingMachine extends Ground{
	...
	/**
	 * an array of buyActions that hold an option of what a player can buy from the vending machine
	 */
	...
	public VendingMachine() {
		...
		buyActions = new BuyAction[]
		{
			...
			new BuyAction(new VegetarianMealKit()),
			new BuyAction(new StegosaurEgg()),
			new BuyAction(new AllosaurEgg()),
			new BuyAction(new BrachiosaurEgg()),
			new BuyAction(new PterodactylsEgg()),
