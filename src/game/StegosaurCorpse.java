...
/**
 * This is a public class StegosaurCorpse that is a child of DinosaurCorpse class
 * It gives addFood of 50 once eaten.
 */
public class StegosaurCorpse extends DinosaurCorpse {
     ...
     */
    private final static int ADD_FOOD = 50;
